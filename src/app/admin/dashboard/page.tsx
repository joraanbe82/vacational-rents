  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-600 mt-2">Bienvenido al panel de administración</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-500 mt-1">Propiedades registradas</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-500 mt-1">Huéspedes totales</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-500 mt-1">Por noche</p>
          </CardContent>
        </Card>
      </div>
